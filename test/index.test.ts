...
import { getHtmlContent, isDev, parser, toMarkdownTable } from '../src'

let htmlContent: string
let parserResult: { title: string | undefined, description: string | undefined }[]

describe('should', () => {
  it('is-dev-env', () => {
    expect(isDev).toMatchInlineSnapshot(`true`)
  })
  it('html-content', async () => {
    htmlContent = await getHtmlContent()
    expect(htmlContent.slice(0, 15)).toMatchInlineSnapshot(`"<!doctype html>"`)
  })
  it('parser', () => {
    parserResult = parser(htmlContent)
    expect(parserResult).toMatchInlineSnapshot(`
      [
        {
          "description": "允许扩展程序在使用 chrome.accessibilityFeatures API 时修改无障碍功能的状态。显示警告：更改您的无障碍设置。",
          "title": "accessibilityFeatures.modify",
        },
        {
          "description": "允许扩展程序在使用 chrome.accessibilityFeatures API 时读取无障碍功能状态。显示警告：读取您的无障碍设置。",
          "title": "accessibilityFeatures.read",
        },
        {
          "description": "通过用户手势临时访问使用中的标签页。如需了解详情，请参阅 activeTab。",
          "title": "activeTab",
        },
        {
          "description": "授予对 chrome.alarms API 的访问权限。",
          "title": "alarms",
        },
        {
          "description": "授予对 chrome.audio API 的访问权限。",
          "title": "audio",
        },
        {
          "description": "使 Chrome 尽早启动（在用户登录到计算机之前，启动 Chrome 之前），并推迟关闭（即使最后一个窗口关闭，直到用户明确退出 Chrome）。",
          "title": "background",
        },
        {
          "description": "授予对 chrome.bookmarks API 的访问权限。显示警告：读取和更改您的书签。",
          "title": "bookmarks",
        },
        {
          "description": "授予对 chrome.browsingData API 的访问权限。",
          "title": "browsingData",
        },
        {
          "description": "授予对 chrome.certificateProvider API 的访问权限。",
          "title": "certificateProvider",
        },
        {
          "description": "允许扩展程序使用网络平台 Clipboard API 从剪贴板粘贴项目。显示警告：读取您复制和粘贴的数据。",
          "title": "clipboardRead",
        },
        {
          "description": "允许扩展程序使用网络平台 Clipboard API 剪切内容并将其复制到剪贴板。显示警告：请修改您复制和粘贴的数据。",
          "title": "clipboardWrite",
        },
        {
          "description": "授予对 chrome.contentSettings API 的访问权限。显示的警告：请更改您的设置，以控制网站对 Cookie、JavaScript、插件、地理定位、麦克风、摄像头等功能的使用权限。",
          "title": "contentSettings",
        },
        {
          "description": "授予对 chrome.contextMenus API 的访问权限。",
          "title": "contextMenus",
        },
        {
          "description": "授予对 chrome.cookies API 的访问权限。",
          "title": "cookies",
        },
        {
          "description": "授予对 chrome.debugger API 的访问权限。显示的警告：访问页面调试程序后端。读取和更改您在所有网站上的所有数据。",
          "title": "debugger",
        },
        {
          "description": "授予对 chrome.declarativeContent API 的访问权限。",
          "title": "declarativeContent",
        },
        {
          "description": "授予对 chrome.declarativeNetRequest API 的访问权限。显示的警告：屏蔽任何网页上的内容。",
          "title": "declarativeNetRequest",
        },
        {
          "description": "提供对 chrome.declarativeNetRequest API 的访问权限，但需要所有操作的主机权限。",
          "title": "declarativeNetRequestWithHostAccess",
        },
        {
          "description": "授予在使用 chrome.declarativeNetRequest API 时向开发者工具控制台写入错误和警告的权限。此权限只能用于已解压的扩展程序，而对于从 Chrome 应用商店安装的扩展程序，系统会忽略此权限。显示警告：读取您的浏览记录。",
          "title": "declarativeNetRequestFeedback",
        },
        {
          "description": "授予对 chrome.dns API 的访问权限。",
          "title": "dns",
        },
        {
          "description": "授予对 chrome.desktopCapture API 的访问权限。显示警告：截取屏幕上的内容。",
          "title": "desktopCapture",
        },
        {
          "description": "授予对 chrome.documentScan API 的访问权限。",
          "title": "documentScan",
        },
        {
          "description": "授予对 chrome.downloads API 的访问权限。显示的警告：管理下载内容。",
          "title": "downloads",
        },
        {
          "description": "允许使用 chrome.downloads.open()。显示的警告：管理下载内容。",
          "title": "downloads.open",
        },
        {
          "description": "允许使用 chrome.downloads.setUiOptions()。显示的警告：管理下载内容。",
          "title": "downloads.ui",
        },
        {
          "description": "授予对 chrome.enterprise.deviceAttributes API 的访问权限。",
          "title": "enterprise.deviceAttributes",
        },
        {
          "description": "授予对 chrome.enterprise.hardwarePlatform API 的访问权限。",
          "title": "enterprise.hardwarePlatform",
        },
        {
          "description": "授予对 chrome.enterprise.networkingAttributes API 的访问权限。",
          "title": "enterprise.networkingAttributes",
        },
        {
          "description": "授予对 chrome.enterprise.platformKeys API 的访问权限。",
          "title": "enterprise.platformKeys",
        },
        {
          "description": "授予对 Favicon API 的访问权限。显示警告：请读出您所访问的网站的图标。",
          "title": "favicon",
        },
        {
          "description": "授予对 chrome.fileBrowserHandler API 的访问权限。",
          "title": "fileBrowserHandler",
        },
        {
          "description": "授予对 chrome.fileSystemProvider API 的访问权限。",
          "title": "fileSystemProvider",
        },
        {
          "description": "授予对 chrome.fontSettings API 的访问权限。",
          "title": "fontSettings",
        },
        {
          "description": "授予对 chrome.gcm 和 chrome.instanceID API 的访问权限。",
          "title": "gcm",
        },
        {
          "description": "允许扩展程序使用 Geolocation API，而不提示用户授予权限。显示的警告：检测您的实际位置。",
          "title": "geolocation",
        },
        {
          "description": "授予对 chrome.history API 的访问权限。显示警告：读取和更改您的所有登录设备上的浏览记录。",
          "title": "history",
        },
        {
          "description": "授予对 chrome.identity API 的访问权限。显示的警告：请记得您的电子邮件地址。",
          "title": "identity",
        },
        {
          "description": "通过 chrome.identity API 授予对用户的电子邮件地址的访问权限。显示的警告：请记得您的电子邮件地址。",
          "title": "identity.email",
        },
        {
          "description": "授予对 chrome.idle API 的访问权限。",
          "title": "idle",
        },
        {
          "description": "授予对 chrome.loginState API 的访问权限。",
          "title": "loginState",
        },
        {
          "description": "授予对 chrome.management API 的访问权限。显示的警告：管理您的应用、扩展程序和主题。",
          "title": "management",
        },
        {
          "description": "授予对原生消息传递 API 的访问权限。显示的警告：与协作的原生应用通信。",
          "title": "nativeMessaging",
        },
        {
          "description": "授予对 chrome.notifications API 的访问权限。显示的警告：显示通知。",
          "title": "notifications",
        },
        {
          "description": "授予对 chrome.offscreen API 的访问权限。",
          "title": "offscreen",
        },
        {
          "description": "授予对 chrome.pageCapture API 的访问权限。显示警告：读取和更改您在所有网站上的所有数据。",
          "title": "pageCapture",
        },
        {
          "description": "授予对 chrome.platformKeys API 的访问权限。",
          "title": "platformKeys",
        },
        {
          "description": "授予对 chrome.power API 的访问权限。",
          "title": "power",
        },
        {
          "description": "授予对 chrome.printerProvider API 的访问权限。",
          "title": "printerProvider",
        },
        {
          "description": "授予对 chrome.printing API 的访问权限。",
          "title": "printing",
        },
        {
          "description": "授予对 chrome.printingMetrics API 的访问权限。",
          "title": "printingMetrics",
        },
        {
          "description": "授予对 chrome.privacy API 的访问权限。显示警告：请更改与隐私相关的设置。",
          "title": "privacy",
        },
        {
          "description": "授予对 chrome.processes API 的访问权限。",
          "title": "processes",
        },
        {
          "description": "授予对 chrome.proxy API 的访问权限。显示警告：读取和更改您在所有网站上的所有数据。",
          "title": "proxy",
        },
        {
          "description": "授予对 chrome.readingList API 的访问权限。显示警告：读取和更改阅读清单中的条目。",
          "title": "readingList",
        },
        {
          "description": "授予对 runtime.connectNative() 和 runtime.sendNativeMessage() 的访问权限。对于 runtime 命名空间的所有其他功能，无需任何权限。",
          "title": "runtime",
        },
        {
          "description": "授予对 chrome.scripting API 的访问权限。",
          "title": "scripting",
        },
        {
          "description": "授予对 chrome.search API 的访问权限。",
          "title": "search",
        },
        {
          "description": "授予对 chrome.sessions API 的访问权限。显示的警告：与 "history" 权限搭配使用时：读取和更改您的所有已登录设备上的浏览记录。与 "tabs" 权限搭配使用时：读取您在所有登录过的设备上的浏览记录。",
          "title": "sessions",
        },
        {
          "description": "授予对 chrome.sidePanel API 的访问权限。",
          "title": "sidePanel",
        },
        {
          "description": "授予对 chrome.storage API 的访问权限。",
          "title": "storage",
        },
        {
          "description": "授予对 chrome.system.cpu API 的访问权限。",
          "title": "system.cpu",
        },
        {
          "description": "授予对 chrome.system.display API 的访问权限。",
          "title": "system.display",
        },
        {
          "description": "授予对 chrome.system.memory API 的访问权限。",
          "title": "system.memory",
        },
        {
          "description": "授予对 chrome.system.storage API 的访问权限。显示的警告：识别并弹出存储设备。",
          "title": "system.storage",
        },
        {
          "description": "授予对 chrome.tabCapture API 的访问权限。显示警告：读取和更改您在所有网站上的所有数据。",
          "title": "tabCapture",
        },
        {
          "description": "授予对 chrome.tabGroups API 的访问权限。显示的警告：查看和管理您的标签页分组。",
          "title": "tabGroups",
        },
        {
          "description": "授予对多个 API（包括 chrome.tabs 和 chrome.windows）使用的 Tab 对象的特权字段的访问权限。您通常无需声明此权限即可使用这些 API。显示警告：读取您的浏览记录。",
          "title": "tabs",
        },
        {
          "description": "授予对 chrome.topSites API 的访问权限。显示的警告：读取您最常访问的网站列表。",
          "title": "topSites",
        },
        {
          "description": "授予对 chrome.tts API 的访问权限。",
          "title": "tts",
        },
        {
          "description": "授予对 chrome.ttsEngine API 的访问权限。显示了警告：读出使用合成语音说出的所有文字。",
          "title": "ttsEngine",
        },
        {
          "description": "提供无限制的 chrome.storage.local、IndexedDB、Cache Storage 和 Origin Private File System 配额。如需了解详情，请参阅存储和 Cookie。",
          "title": "unlimitedStorage",
        },
        {
          "description": "授予对 chrome.vpnProvider API 的访问权限。",
          "title": "vpnProvider",
        },
        {
          "description": "授予对 chrome.wallpaper API 的访问权限。",
          "title": "wallpaper",
        },
        {
          "description": "授予对 chrome.webAuthenticationProxy API 的访问权限。显示警告：读取和更改您在所有网站上的所有数据。",
          "title": "webAuthenticationProxy",
        },
        {
          "description": "授予对 chrome.webNavigation API 的访问权限。显示警告：读取您的浏览记录。",
          "title": "webNavigation",
        },
        {
          "description": "授予对 chrome.webRequest API 的访问权限。",
          "title": "webRequest",
        },
        {
          "description": "允许使用 chrome.webRequest API 进行屏蔽。",
